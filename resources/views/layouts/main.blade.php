        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
         ...
         @auth
            <ul class="navbar-nav">
                ...
                <li class="nav-item {{ request()->segment(1) == 'companies' ? 'active' : ''  }} "><a href="{{ route('contacts.index') }}" class="nav-link">Contacts</a></li>
            </ul>
         @endauth
          ...
          <li class="nav-item mr-2"><a href="{{ route('login') }}" class="btn btn-outline-secondary">Login</a></li>
            ...
            @else
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{ auth()->user()->fullName() }} {{-- original line: {{ auth()->user()->name }}   --}}
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="{{ route('settings.profile.edit') }} ">Settings</a> {{--  {{ route('settings.profile.edit') }}  --}}
                    {{--  posted code    --}}
