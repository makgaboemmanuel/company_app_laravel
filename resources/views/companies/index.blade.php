...
@section('Contact App | All Companies')
              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                        {{-- @if($message = session('message'))
                            <div class="alert alert-succcess" role="alert">{{ $message  }} </div>
                        @endif --}}
                        ...
                        @if ($companies->count() )
                            ...
                            <tr>
                                ...
                                <td> {{ $company->email }} </td>
                                <td> {{ $company->contacts_count }} </td> {{-- original line: $company->contacts->count()  --}}
                                <td width="150">
